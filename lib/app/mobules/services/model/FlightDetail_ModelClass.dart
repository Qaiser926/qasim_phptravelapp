...
FlightDetailModelClass flightDetailModelClassFromJson(String str) =>
    FlightDetailModelClass.fromJson(json.decode(str));
String flightDetailModelClassToJson(FlightDetailModelClass data) =>
    json.encode(data.toJson());

class FlightDetailModelClass {
  FlightDetailModelClass({
    String? id,
    String? name,
    String? location,
    String? stars,
  ...
  FlightDetailModelClass.fromJson(dynamic json) {
    _id = json['id'];
    _name = json['name'];
  ...
  String? _discount;
  FlightDetailModelClass copyWith({
    String? id,
    String? name,
    String? location,
    String? stars,
...
PaymentOption paymentOptionFromJson(String str) =>
    PaymentOption.fromJson(json.decode(str));
String paymentOptionToJson(PaymentOption data) => json.encode(data.toJson());
...
Amenities amenitiesAirportFromJson(String str) =>
    Amenities.fromJson(json.decode(str));
String amenitiesAirportToJson(Amenities data) => json.encode(data.toJson());

class AmenitiesAirport {
  Amenities({
    String? icon,
    String? name,
  }) {
  ...
  AmenitiesAirport.fromJson(dynamic json) {
    _icon = json['icon'];
    _name = json['name'];
  }
  String? _icon;
  String? _name;
  AmenitiesAirport copyWith({
    String? icon,
    String? name,
  }) =>
      Amenities(
