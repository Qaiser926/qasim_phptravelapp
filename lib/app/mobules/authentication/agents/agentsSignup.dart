...
class AgentsSignupPage extends StatefulWidget {
  const AgentsSignupPage({Key? key}) : super(key: key);

  @override
  State<AgentsSignupPage> createState() => _AgentsSignupPageState();
}

class _AgentsSignupPageState extends State<AgentsSignupPage> {
  ...
  Container autocompleteTextfield() {
    return Container(
      ...
      child: Autocomplete<String>(
          ...
          initialValue: TextEditingValue(text: 'Agents'),
